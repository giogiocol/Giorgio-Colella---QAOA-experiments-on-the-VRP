...
qaoa_params_small = {
    1: {'beta': [-0.62467604], 'gamma': [0.54171414]},
    2: {'beta': [-0.74058968, -0.43396946], 'gamma': [0.38493868, 0.66685668]},
    3: {'beta': [-0.73431993, -0.5299151 , -0.26545287], 'gamma': [0.26468658, 0.4928848 , 0.77954885]},
    4: {'beta': [-0.77345379, -0.724297, -0.53282351, -0.27346677], 'gamma': [-0.02620447, 0.24912793, 0.4646915, 0.72890292]},
    5: {'beta': [-0.68096513, -0.54011979, -0.33248435, -0.09894717, -0.15789594],
        'gamma': [0.19909329, 0.37240574, 0.4961008, 0.40889859, 0.53102674]},
    6: {'beta': [-0.70705368, -0.54497215, -0.31246076, -0.19570384, -0.06553837, -0.11917838],
        'gamma': [0.20273113, 0.37169018, 0.4569773, 0.42146468, 0.45730607, 0.47940979]}
}

for reps in reps_range:
    print(f"--------------NEW REPS : {reps} / {len(reps_range)} ------------------")
    ...
    init_params = [qaoa_params_small[reps]['beta'], qaoa_params_small[reps]['gamma']]
    ...
    print("QAOA Feasible Optimal Solution Percentage:", opt_perc_QAOA_ideal)
